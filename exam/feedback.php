...
<body>
    <nav class="navbar navbar-expand-md sticky-top mt-5" style="background-color: rgba(0, 0, 0, 0.6);" >
            ...
            <div class="row">
              <div class="col-md-7 col-sm-6 offset-md-3 text-white" style="background-color: rgba(0, 0, 0, 0.2);">
                ...
                <form action="" method="POST" class="p-3" id="myForm">
                  ...
                  <button class="btn btn-danger mt-2 p-1 font-weight-bold mr-4" name="confirm" onclick="resetForm();">Submit</button>
